...
const snapshotTestingHost = IS_CI ? 'localhost' : DOCKER_HOST;
const connectOptions = IS_CI ? undefined : {wsEndpoint: `ws://127.0.0.1:${process.env.PLAYWRIGHT_PORT}/string`};
...
export default defineConfig({
    ...
    globalSetup: IS_CI ? undefined : './test/snapshot/utils/ChromeContainer/server-start.ts',
    globalTeardown: IS_CI ? undefined : './test/snapshot/utils/ChromeContainer/teardown.ts',
});
